const Home = () => {
  return (
    <div className="p-8">
      <h1 className="text-white text-xl font-bold mt-8 mb-4">Darts Fight Club</h1>
      <p className="text-white text-md font-normal mb-4">"Alles was du nicht checkst, checkt irgendwann dich"</p>
